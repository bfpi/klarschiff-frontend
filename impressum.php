...
<html>
  ...
  <body>
    ...
    <div id="content" class="container center">
      ...
      <p class="justified">
        Trotz sorgfältigen Recherchen und Prüfungen übernimmt die Universitäts- und Hansestadt Greifswald für die Richtigkeit, Vollständigkeit und Aktualität der von ihr angebotenen Inhalte keine Gewähr und keine Haftung. Insbesondere haftet die Universitäts- und Hansestadt Greifswald nicht für Schäden, die durch die direkte oder indirekte Nutzung oder Nichtnutzung der angebotenen Inhalte verursacht werden. Die Universitäts- und Hansestadt Greifswald behält es sich ferner ausdrücklich vor, einzelne Inhalte oder das gesamte Angebot ohne gesonderte Ankündigung zu verändern, zu ergänzen, zu löschen oder die Veröffentlichung zeitweise oder endgültig einzustellen.<br/>
        Die Universitäts- und Hansestadt Greifswald ist als Diensteanbieterin gemäß § 7 Abs. 1 Telemediengesetz (TMG) für ihre eigenen Inhalte, die sie zur Nutzung bereithält, verantwortlich. Gemäß §§ 8 bis 10 TMG ist sie jedoch nicht verpflichtet, von fremden Eigentümern übermittelte oder gespeicherte Inhalte, die sie zur Nutzung bereithält, auf etwaige Rechtsverletzungen zu überprüfen. Gleichwohl verpflichtet sie sich zur umgehenden Entfernung betroffener Inhalte ab dem Zeitpunkt der Kenntnis einer konkreten Rechtsverletzung.
      </p>

      <h2>Haftung für externe Links</h2>
      <p class="justified">
        Für die von Dritten angebotenen fremden Inhalte, auf die mittels externer Links verwiesen ist, übernimmt die Universitäts- und Hansestadt Greifswald keine Gewähr und keine Haftung, da sich diese Inhalte ihrer Einflussnahme entziehen. Verantwortlich für diese Inhalte ist stets der jeweilige Anbieter.<br/>
        Alle mittels externer Links verknüpfte fremde Inhalte wurden zum Zeitpunkt ihrer Verlinkung auf mögliche Rechtsverletzungen überprüft, mit dem Resultat, dass keine konkreten Rechtsverletzungen erkannt wurden. Die kontinuierliche Kontrolle der verlinkten Inhalte allerdings ist ohne Anhaltspunkte für eine konkrete Rechtsverletzung nicht zumutbar. Sollte die Universitäts- und Hansestadt Greifswald hingegen von einer konkreten Rechtsverletzung Kenntnis erlangen, wird sie die entsprechenden externen Links umgehend entfernen.
      </p>

      <h2>Urheberrecht</h2>
      <p class="justified">
        Die von der Universitäts- und Hansestadt Greifswald angebotenen und in ihrem Eigentum befindlichen Kartenbilder unterliegen der freien Lizenz <a href="http://creativecommons.org/licenses/by/3.0/deed.de" target="_blank">Creative Commons Namensnennung 3.0</a> (CC BY 3.0). Damit ist es gestattet die Kartenbilder zu kopieren, zu verbreiten, öffentlich zugänglich zu machen, Abwandlungen und Bearbeitungen anzufertigen sowie die Kartenbilder kommerziell zu nutzen. Allein der Quellenvermerk ist stets und bei jedweder Art der Nutzung erforderlich und wie folgt auszugestalten: © Universitäts- und Hansestadt Greifswald (CC BY 3.0).<br/>
        Die von der Universitäts- und Hansestadt Greifswald angebotenen und in ihrem Eigentum befindlichen sonstigen Inhalte sind urheberrechtlich geschützt und dienen ausschließlich Informationszwecken. Für nicht kommerzielle Zwecke ist es gestattet die Inhalte zu kopieren, zu verbreiten, öffentlich zugänglich zu machen sowie Abwandlungen und Bearbeitungen anzufertigen. Die Nutzung der Inhalte für kommerzielle Zwecke hingegen bedarf der vorherigen schriftlichen Zustimmung der Universitäts- und Hansestadt Greifswald und ist gegebenenfalls nur gegen Entgelt möglich. Der Quellenvermerk ist stets und bei jedweder Art der Nutzung erforderlich und wie folgt auszugestalten: © Universitäts- und Hansestadt Greifswald.<br/>
        Angebotene Inhalte und/oder diesen zugrundeliegende Daten, die von fremden Eigentümern übermittelt oder gespeichert wurden, unterliegen den Urheberrechten der jeweiligen eingetragenen Eigentümer und sind als Inhalte und/oder diesen zugrundeliegende Daten Dritter mit einem Quellenvermerk kenntlich gemacht. Sollte die Universitäts- und Hansestadt Greifswald dennoch von einer Urheberrechtsverletzung Kenntnis erlangen, wird sie die betroffenen Inhalte und/oder diesen zugrundeliegende Daten umgehend entfernen.
      </h2>

      <h2>Verweise auf angebotene Inhalte</h2>
      <p class="justified">
      ...
      <p class="justified">
        Die Universitäts- und Hansestadt Greifswald verpflichtet sich in ihren Leitlinien zur Stadtentwicklung die zum 26. März 2009 in Deutschland in Kraft getretene Behindertenrechtskonvention der Vereinten Nationen schrittweise umzusetzen. In ihren Internetauftritten achtet die Universitäts- und Hansestadt Greifswald daher auf die Einhaltung der Barrierefreien Informationstechnik-Verordnung (BITV 2.0). Bei der Erstellung des vorliegenden Angebotes konnten die Vorgaben der BITV 2.0 hingegen nicht berücksichtigt werden, da die Grenzen der Barrierefreiheit in der Darstellung digitaler Karten liegen.
      </p>

      <h2>Nutzung der Kontaktdaten</h2>
      <p class="justified">
        Der unverlangten Nutzung der in diesem Impressum veröffentlichten Kontaktdaten der Universitäts- und Hansestadt Greifswald durch Dritte, insbesondere der Zustellung unangeforderter Werbe- oder Informationsmaterialien, widerspricht die Universitäts- und Hansestadt Greifswald hiermit ausdrücklich. Sie behält sich ferner rechtliche Schritte gegen Dritte im Falle der Zustellung unangeforderter Werbe- oder Informationsmaterialien vor.
      </p>

      <h2>Kontakt</h2>
      <p>
        Kommentare, Anregungen und Kritik zu dem vorliegenden Angebot der Universitäts- und Hansestadt Greifswald richten Sie bitte an:<br/>
        <a href="mailto:stadtverwaltung@greifswald.de">stadtverwaltung@greifswald.de</a><br/>
      </p>
    </div>
  </body>
</html>
