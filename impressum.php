...
<html>
  <head>
    ...
    <title>Klarschiff.HRO – Portal zur Bürgerbeteiligung der Hansestadt Rostock – Impressum</title>
  ...
  <body>
    ...
    <div class="container center">
      ...
      <p>
        ...
        18050 Rostock<br/>
        Telefon: +49 381 381-1417<br/>
        Telefax: +49 381 381-9130<br/>
        E-Mail: <a href="mailto:presse@rostock.de">presse@rostock.de</a><br/>
      </p>
      ...
      <p>
        ...
        Büro des Oberbürgermeisters<br/>
        Ulrich Kunze<br/>
        Pressesprecher Presse- und Informationsstelle<br/>
        Hinter dem Rathaus 5<br/>
        18055 Rostock<br/>
        Telefon: +49 381 381-1418<br/>
        Telefax: +49 381 381-9135<br/>
        E-Mail: <a href="mailto:presse@rostock.de">presse@rostock.de</a><br/>
      </p>
      ...
      <p>
        ...
        Holbeinplatz 14<br/>
        18069 Rostock<br/>
        Telefon: +49 381 381-6281<br/>
        Telefax: +49 381 381-6902<br/>
        E-Mail: <a href="mailto:klarschiff.hro@rostock.de">klarschiff.hro@rostock.de</a><br/>
      </p>
      ...
      <p>
        Fraunhofer IGD<br/>
        Joachim-Jungius-Straße 11<br/>
        18059 Rostock<br/>
        Telefon: +49 381 4024-110<br/>
        Telefax: +49 381 4024-199<br/>
        E-Mail: <a href="mailto:info@igd-r.fraunhofer.de">info@igd-r.fraunhofer.de</a><br/>
      </p>
      <p>
        WhereGroup GmbH & Co. KG<br/>
        Eifelstraße 7<br/>
        53119 Bonn<br/>
        Telefon: +49 228 909038-0<br/>
      ...
      <p class="justified">
        Trotz sorgfältigen Recherchen und Prüfungen übernimmt die Hansestadt Rostock für die Richtigkeit, Vollständigkeit und Aktualität der von ihr angebotenen Inhalte keine Gewähr und keine Haftung. Insbesondere haftet die Hansestadt Rostock nicht für Schäden, die durch die direkte oder indirekte Nutzung oder Nichtnutzung der angebotenen Inhalte verursacht werden. Die Hansestadt Rostock behält es sich ferner ausdrücklich vor, einzelne Inhalte oder das gesamte Angebot ohne gesonderte Ankündigung zu verändern, zu ergänzen, zu löschen oder die Veröffentlichung zeitweise oder endgültig einzustellen.<br/>
        Die Hansestadt Rostock ist als Diensteanbieterin gemäß § 7 Abs. 1 Telemediengesetz (TMG) für ihre eigenen Inhalte, die sie zur Nutzung bereithält, verantwortlich. Gemäß §§ 8 bis 10 TMG ist sie jedoch nicht verpflichtet, von fremden Eigentümern übermittelte oder gespeicherte Inhalte, die sie zur Nutzung bereithält, auf etwaige Rechtsverletzungen zu überprüfen. Gleichwohl verpflichtet sie sich zur umgehenden Entfernung betroffener Inhalte ab dem Zeitpunkt der Kenntnis einer konkreten Rechtsverletzung.
      </p>

      <h2>Haftung für externe Links</h2>
      <p class="justified">
        Für die von Dritten angebotenen fremden Inhalte, auf die mittels externer Links verwiesen ist, übernimmt die Hansestadt Rostock keine Gewähr und keine Haftung, da sich diese Inhalte ihrer Einflussnahme entziehen. Verantwortlich für diese Inhalte ist stets der jeweilige Anbieter.<br/>
        Alle mittels externer Links verknüpfte fremde Inhalte wurden zum Zeitpunkt ihrer Verlinkung auf mögliche Rechtsverletzungen überprüft, mit dem Resultat, dass keine konkreten Rechtsverletzungen erkannt wurden. Die kontinuierliche Kontrolle der verlinkten Inhalte allerdings ist ohne Anhaltspunkte für eine konkrete Rechtsverletzung nicht zumutbar. Sollte die Hansestadt Rostock hingegen von einer konkreten Rechtsverletzung Kenntnis erlangen, wird sie die entsprechenden externen Links umgehend entfernen.
      </p>
      ...
      <p class="justified">
        Die Hansestadt Rostock verpflichtet sich in ihren Leitlinien zur Stadtentwicklung die zum 26. März 2009 in Deutschland in Kraft getretene Behindertenrechtskonvention der Vereinten Nationen schrittweise umzusetzen. In ihren Internetauftritten achtet die Hansestadt Rostock daher auf die Einhaltung der Barrierefreien Informationstechnik-Verordnung (BITV 2.0). Bei der Erstellung des vorliegenden Angebotes konnten die Vorgaben der BITV 2.0 hingegen nicht berücksichtigt werden, da die Grenzen der Barrierefreiheit in der Darstellung digitaler Karten liegen.
      </p>

      <h2>Nutzung der Kontaktdaten</h2>
      <p class="justified">
        Der unverlangten Nutzung der in diesem Impressum veröffentlichten Kontaktdaten der Hansestadt Rostock durch Dritte, insbesondere der Zustellung unangeforderter Werbe- oder Informationsmaterialien, widerspricht die Hansestadt Rostock hiermit ausdrücklich. Sie behält sich ferner rechtliche Schritte gegen Dritte im Falle der Zustellung unangeforderter Werbe- oder Informationsmaterialien vor.
      </p>

      <h2>Kontakt</h2>
      <p>
        Kommentare, Anregungen und Kritik zu dem vorliegenden Angebot der Hansestadt Rostock richten Sie bitte an:<br/>
        <a href="mailto:klarschiff.hro@rostock.de">klarschiff.hro@rostock.de</a><br/>
      </p>
    </div>
  </body>
</html>
