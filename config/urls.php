...
define("STADTTEILE_WFS_URL", $wfs_query . "&typeName=hro-demo.klarschiff.ortsteile&outputFormat=GeoJSON");
define("GEORSS_URL", $geoserver_base . "&typeName=hro-demo.klarschiff.meldungen_beobachtungsflaechen&outputFormat=GeoRSS&srsName=EPSG:4326");
