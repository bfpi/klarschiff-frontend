...
<html>
  ...
  <body>
    ...
    <div class="container center">
      <h1>Hilfe des Desktop-Frontends von <span class="italic">Klarschiff</span> im Demobetrieb der Hansestadt Rostock</h1>
      ...
      <p>
        ...
        <span class="small">•••</span>
        <br/>
        <a href="#subheadline03">OK, überzeugt. Wie fange ich an?</span></a>
        <br/>
        <a class="small" href="#section03_01">(1) Karte aufrufen</span></a>
        <br/>
        <a class="small" href="#section03_02">(2) auf Karte zurechtfinden</span></a>
        <br/>
        <a class="small" href="#section03_03">(3) vorhandene Meldungen ansehen</span></a>
        <br/>
        <a class="small" href="#section03_04">(4) vorhandene Meldungen verstehen</span></a>
        <br/>
        <span class="small">•••</span>
        <br/>
        <a href="#subheadline04">Wie werde ich selbst aktiv?</span></a>
        <br/>
        <a class="small" href="#section04_01">(1) auf vorhandene Meldung reagieren</span></a>
        <br/>
        <a class="small" href="#section04_02">(2) neue Meldung erstellen</span></a>
        <br/>
        <span class="small">•••</span>
        <br/>
        <a href="#subheadline05">Wie bleibe ich auf dem Laufenden?</span></a>
        <br/>
        <a class="small" href="#section05_01">(1) Meldungen verfolgen</span></a>
        <br/>
        <a class="small" href="#section05_02">(2) über Neuigkeiten informiert werden</span></a>
        <br/>
        <a class="small" href="#section05_03">(3) über Neuigkeiten in einem bestimmten Gebiet informiert werden</span></a>
        <br/>
        <span class="small">•••</span>
        <br/>
        <a href="#subheadline06">Muss ich sonst noch etwas wissen?</a>
        <br/>
        <span class="small">•••</span>
        <br/>
      ...
      <p class="screenshot clearfix">
        ...
        <span class="right"><img src="images/hilfe_screenshot02.png" alt="screenshot_02" title="Adressensuche nutzen" /></span>
      </p>
      <p class="screenshot annotation clearfix">
        <span class="left">Die Karte kann direkt durch Anklicken der entsprechenden Links aufgerufen werden…</span>
        <span class="right">…oder aber durch die vorherige Nutzung der Adressensuche.</span>
      </p>
      <h3><a name="section03_02"></a>(2) auf Karte zurechtfinden</h3>
      <p class="justified">
      ...
      <p class="screenshot clearfix">
        <span class="left"><img src="images/hilfe_screenshot03.png" alt="screenshot_03" title="Navigationselemente für Karte" /></span>
        <span class="right"><img src="images/hilfe_screenshot04.png" alt="screenshot_04" title="Menü auf Kartenseite" /></span>
      </p>
      <p class="screenshot annotation clearfix">
        <span class="left">Die vier Pfeiltasten ermöglichen das Verschieben der Karte, die Plus-Taste das Hineinzoomen, die Minus-Taste das Herauszoomen und der Globus das Springen auf die komplette Ansicht von Rostock.</span>
        <span class="right">Sie können unter anderem zwischen dem Stadtplan und dem Luftbild als <span class="bold">Kartenhintergrund wählen</span> oder abermals nach einer Adresse suchen. Die übrigen Menüpunkte werden weiter unten erläutert.</span>
      </p>
      <h3><a name="section03_03"></a>(3) vorhandene Meldungen ansehen</h3>
      <p class="justified">
      ...
      <p class="screenshot clearfix">
        <span class="left"><img src="images/hilfe_screenshot05.png" alt="screenshot_05" title="Bedeutung der Kartensymbole" /></span>
        <span class="right"><img src="images/hilfe_screenshot06.png" alt="screenshot_06" title="Pop-up zu vorhandener Meldung" /></span>
      </p>
      <p class="screenshot annotation clearfix">
        <span class="left">Ein Klick auf den Menüpunkt <span class="italic">Kartenelemente</span> öffnet eine Übersicht aller Kartensymbole und deren Bedeutungen: Hier können Sie die verschiedenen Symbolarten auch weg- oder zuschalten.</span>
        <span class="right">Wenn Sie auf ein Symbol in der Karte klicken, öffnet sich ein <span class="bold">Pop-up</span> mit den wichtigsten Angaben zur entsprechenden Meldung. Ein Klick auf den Button <span class="bold"><span class="italic">Details</span></span> zeigt weitere, detaillierte Angaben zur Meldung.</span>
      </p>
      ...
      <h3><a name="section04_01"></a>(1) auf vorhandene Meldung reagieren</h3>
      <p class="justified">
      ...
      <p class="screenshot clearfix large">
        ...
        <span class="right"><img src="images/hilfe_screenshot16.png" alt="screenshot_16" title="Lob, Hinweise oder Kritik zu einer Meldung" /></span>
        <span class="center"><img src="images/hilfe_screenshot08.png" alt="screenshot_08" title="Missbrauch melden" /></span>
      </p>
      ...
      <p class="screenshot clearfix">
        <span class="left"><img src="images/hilfe_screenshot09.png" alt="screenshot_09" title="Menüpunkt „neue Meldung“ auswählen" /></span>
        <span class="right"><img src="images/hilfe_screenshot10.png" alt="screenshot_10" title="Symbol in Karte bewegen" /></span>
      </p>
      <p class="screenshot annotation clearfix">
        <span class="left">Im Menü <span class="italic">neue Meldung</span> und dann entweder Problem oder Idee auswählen,…</span>
        <span class="right">…das Symbol auf der Karte an die richtige Stelle schieben,…</span>
      </p>
      <p class="screenshot clearfix">
        <span class="left"><img src="images/hilfe_screenshot11.png" alt="screenshot_11" title="„Sprechblase“ bedienen" /></span>
        <span class="right"><img src="images/hilfe_screenshot12.png" alt="screenshot_12" title="Dialog ausfüllen und abschicken" /></span>
      </p>
      <p class="screenshot annotation clearfix">
        <span class="left">…in der „Sprechblase“ auf <span class="italic">beschreiben</span> klicken,…</span>
        <span class="right">…im Dialog Angaben zur neuen Meldung machen und abschicken. Geschafft!</span>
      </p>
      ...
      <h3><a name="section05_03"></a>(3) über Neuigkeiten in einem bestimmten Gebiet informiert werden</h3>
      <p class="justified">
